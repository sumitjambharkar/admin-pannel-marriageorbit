...
const Female = () => {
 ...
 <div class="panel panel-default">
    <div class="panel-heading">
        <h3>
    Female table({female.length})<input value={search}
      ...
      <table class="table" ui-jq="footable" ui-options='{
        ...
        <tbody>
          ...
          .map((doc,i)=>(
            ...
            <img style={{width:"50px",borderRadius:"50%",height:"50px"}} src="https://img.icons8.com/fluency/48/null/person-female.png"/>}
            </td>
