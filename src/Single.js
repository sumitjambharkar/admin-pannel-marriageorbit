...
const Single = () => {
  ...
  const addProfile = (data) => {
    let text = "Add Profile Done";
    if (window.confirm(text) === true) {
      text = "You pressed OK!";
      db.collection("Profile").doc(data.uid).set({
        about: data.about,
                    ...
                    <div class="col-lg-8">
                      <div class="card shadow-sm">
                        <div class="card-header card_h bg-transparent border-0">
                          ...
                          <div>
                            <button style={{ borderRadius: "24px", border: "1px solid #aeaeae", margin: 2, padding: 4 }} onClick={() => addProfile(data)}>Select Profile</button>
                            <button style={{ borderRadius: "24px", border: "1px solid #aeaeae", margin: 2, padding: 4 }} onClick={() => updateData(data)}>Update Data</button>
                            <button style={{ borderRadius: "24px", border: "1px solid #aeaeae", margin: 2, padding: 4 }} onClick={editData}>Reset Data</button>
                            <button style={{ borderRadius: "24px", border: "1px solid #aeaeae", margin: 2, padding: 4 }} onClick={deleteData}>Delete User</button>
                            <button style={{ borderRadius: "24px", border: "1px solid #aeaeae", margin: 2, padding: 4 }} onClick={extraData}>Extra</button>
                          </div>
                        </div>
